...
export default function SetEditPage() {
	...
	const handleCreate = (e: Event) => {
		...
		createCardMutation.mutate({ set_id: setId, front: front.trim(), back: back.trim() });
	};
	...
	if (error) {
		return <div class="set-edit-page">Error loading set: {String((error as Error).message)}</div>;
	}
